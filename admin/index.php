...
<div class="stats-grid">
  ...
  <div class="stat"><div class="label">Organizaciones</div><div class="value"><?= (int)$counts['companies'] ?></div><?php if ((int)$counts['companies_pend'] > 0): ?><div class="label" style="color:#F58220;text-transform:none;margin-top:4px;"><?= (int)$counts['companies_pend'] ?> pendiente<?= (int)$counts['companies_pend'] === 1 ? '' : 's' ?></div><?php endif; ?></div>
