...
$page_title = 'Organizaciones — Admin';
...
?>
<div class="toolbar">
  <h1 style="margin:0;">Organizaciones <?php if ($pending_count): ?><span style="background:#F58220;color:#fff;font-size:13px;padding:2px 10px;border-radius:999px;margin-left:8px;vertical-align:middle;"><?= $pending_count ?> pendiente<?= $pending_count===1?'':'s' ?> de aprobación</span><?php endif; ?></h1>
  <a href="<?= e(u('/admin/empresas/edit.php')) ?>" class="btn">+ Nueva organización</a>
</div>
