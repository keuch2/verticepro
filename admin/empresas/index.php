...
$items = DB::all('SELECT c.*, s.name sector_name, co.name country_name FROM companies c LEFT JOIN sectors s ON s.id=c.sector_id LEFT JOIN countries co ON co.id=c.country_id ORDER BY c.name');
